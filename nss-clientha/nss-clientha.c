...
char* CLIENTHA_NAME_FOLDER = "/var/run/clientha/names/";
size_t CLIENTHA_NAME_FOLDER_SIZE = 24; /* strlen(CLIENTHA_NAME_FOLDER) */
...
enum nss_status _nss_clientha_gethostbyname3_r(
                const char *name,
                int af,
                struct hostent *host,
...
enum nss_status _nss_clientha_gethostbyname2_r(
                const char *name,
                int af,
                struct hostent *host,
                char *buffer, size_t buflen,
...
enum nss_status _nss_clientha_gethostbyname_r(
                const char *name,
                struct hostent *host,
                char *buffer, size_t buflen,
                int *errnop, int *h_errnop);
...
static enum nss_status get_hostent(
    ...
    *(char**) r_aliases = NULL;
    ...
    // get host file name
    char *host_file = malloc( sizeof(char) * (l+CLIENTHA_NAME_FOLDER_SIZE+1) );
    strcpy(host_file,CLIENTHA_NAME_FOLDER);
    strcpy(host_file+CLIENTHA_NAME_FOLDER_SIZE,hn);
...
enum nss_status _nss_clientha_gethostbyname2_r(
    ...
    return _nss_clientha_gethostbyname3_r(
                    name,
                    af,
                    host,
                    buffer, buflen,
